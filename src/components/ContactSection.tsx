...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'polarbear56565@gmail.com',
    href: 'mailto:polarbear56565@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '+62  81269388383',
    href: 'tel:+628126938883',
  },
  {
    icon: MapPin,
    label: 'Lokasi',
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                menghubungi nomor saya. Saya sangat terbuka untuk berdiskusi tentang project 
                baru, ide kreatif, atau rencana-rencana yang menarik lainnya.
              </p>
            </div>
