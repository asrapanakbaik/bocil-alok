...
const skills = {
  ...
  backend: [
    ...
    { name: 'Geografi', level: 72 },
    { name: 'Coding', level: 68 },
    { name: 'Bahasa Inggris', level: 93 },
  ],
  tools: [
    { name: 'Fiqih', level: 78 },
    { name: 'Akidah', level: 80 },
    { name: 'Alquran dan Hadist', level: 71 },
    { name: 'SKI', level: 85 },
    { name: 'Bahasa Arab', level: 78 },
  ],
};
